...
class SiswaBiodataController extends Controller
{
  ...
  */
  ...
  {
    $data = Siswa::with(['agama','detil','sekolah','keluarga','keluargajepang','pendidikan'])->where('id',Auth::user()->siswa->id)->first();
    ...
    return view('siswa.biodata.index', compact('data','riwayatpendidikan','riwayatpekerjaan'));
  }
