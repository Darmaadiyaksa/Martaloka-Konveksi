  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="jquery-val-form" class="forms-sample" action="{{route('md.siswa.update')}}" method="post" enctype="multipart/form-data" id="formdosen">
...
<div class="modal fade" id="modal-pendidikan" tabindex="false" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="forms-sample form-pendidikan" action="#" method="post">
          <input type="hidden" name="idsiswa" value="{{$data->id}}">
