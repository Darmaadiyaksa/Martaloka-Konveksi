...
@section('title-head', 'Tambah Foto Galeri')
  ...
  <div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
          <h2 class="content-header-title float-left mb-0">Tambah Foto
          </h2>
          <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('web.galeri')}}">Konten Galeri</a></li>
  ...
  <div class="content-body">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <form id="jquery-val-form" class="forms-sample" action="{{route('web.galeri.store')}}" method="post" enctype="multipart/form-data" id="formdosen">
              <div class="row">
                <div class="col-xl-12 mb-1">
                  <div class="form-group">
                    <label><b>Gambar</b></label>
                    <input type="file" class="upload-photo" name="gambars" data-allow-reorder="true" data-max-file-size="2MB" accept="image/jpeg,image/png,image/jpg" required>
